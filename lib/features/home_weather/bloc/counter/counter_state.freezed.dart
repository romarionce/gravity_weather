...
abstract class $CounterStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int counter, int modifier});
}
...
class _$CounterStateImpl implements _CounterState {
  _$CounterStateImpl(this.counter, this.modifier);
  ...
  @override
  String toString() {
    return 'CounterState(counter: $counter, modifier: $modifier)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, counter, modifier);
...
abstract class _CounterState implements CounterState {
  factory _CounterState(final int counter, final int modifier) =
      _$CounterStateImpl;
